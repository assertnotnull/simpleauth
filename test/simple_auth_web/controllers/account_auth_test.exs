defmodule SimpleAuthWeb.AccountAuthTest do
  use SimpleAuthWeb.ConnCase, async: true

  alias SimpleAuth.Accounts
  alias SimpleAuthWeb.AccountAuth
  import SimpleAuth.AccountsFixtures

  @remember_me_cookie "_simple_auth_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SimpleAuthWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SimpleAuthWeb.Endpoint.subscribe(live_socket_id)
