defmodule SimpleAuth.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, SimpleAuth.Repo)
  ...
  """
  def valid_password?(%SimpleAuth.Accounts.Account{hashed_password: hashed_password}, password)
